...
import com.carlosvicente.uberkotlin.databinding.ActivityTripInfoMotoBinding
...
class TripInfoMotoActivity : AppCompatActivity(), OnMapReadyCallback, Listener, DirectionUtil.DirectionCallBack {

    private lateinit var binding: ActivityTripInfoMotoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTripInfoMotoBinding.inflate(layoutInflater)
        ...
        binding.btnConfirmRequestMoto .setOnClickListener { goToSearchDriverMoto() }
    }

    private fun goToSearchDriverMoto() {
